...
class AccessRestController extends AbstractRestController
{
     ...
     * (спустя полгода не пойму что происходит. и всё-таки видно, что для платного теста токен должен быть по любому,
     *  то есть партнёр так или иначе должен сначала получить токен для юзера - платежный или доступ)
