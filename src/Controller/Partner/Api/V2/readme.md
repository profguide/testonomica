...
Далее я сделал V3 (см V3/readme.md). Потому что V2 предполагает предварительную регистрацию пользователя и хранение его
в системе провайдера, что сложно для него. Пусть работает с своим user_id. Как следствие отпала необходимость
регистрировать пользователя. Регистрация происходит втихую в момент прикрепления результата. Таким образом в V3 стало на
