 ...
 */
final class Version20230820210658 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE author (id INT AUTO_INCREMENT NOT NULL, slug VARCHAR(50) NOT NULL, name VARCHAR(100) NOT NULL, name_en VARCHAR(100) NOT NULL, about LONGTEXT DEFAULT NULL, about_en LONGTEXT DEFAULT NULL, INDEX IDX_BDAFD8C8989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
