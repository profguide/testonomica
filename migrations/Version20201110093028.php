 ...
 */
final class Version20201110093028 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE provider_access (id INT AUTO_INCREMENT NOT NULL, provider_id INT DEFAULT NULL, token VARCHAR(32) NOT NULL, created_at DATETIME NOT NULL, used_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_5158C8C4A53A8AA (provider_id), INDEX IDX_5158C8C45F37A13B (token), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE provider_payment (id INT AUTO_INCREMENT NOT NULL, payment_id INT DEFAULT NULL, provider_id INT DEFAULT NULL, token VARCHAR(32) NOT NULL, user VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_9D7026AA4C3A3BB (payment_id), UNIQUE INDEX UNIQ_9D7026AAA53A8AA (provider_id), INDEX IDX_9D7026AA5F37A13B (token), INDEX IDX_9D7026AAA53A8AA8D93D649 (provider_id, user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
