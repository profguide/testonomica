 ...
 */
final class Version20210410102020 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE question_item (id INT AUTO_INCREMENT NOT NULL, question INT DEFAULT NULL, value VARCHAR(255) NOT NULL, correct TINYINT(1) NOT NULL, text LONGTEXT NOT NULL, text_en LONGTEXT NOT NULL, updated_at DATETIME NOT NULL, img VARCHAR(255) DEFAULT NULL, INDEX IDX_41F5C8F1B6F7494E (question), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
